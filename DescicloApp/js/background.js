...
if(localStorage.getItem('quatro') == "true"){ chrome.windows.onCreated.addListener(function() { localStorage.cinco = "true"; }) }
if(localStorage.getItem('tres') == "true"){ chrome.windows.onCreated.addListener(function() { localStorage.quatro = "true"; }) }
if(localStorage.getItem('dois') == "true"){ chrome.windows.onCreated.addListener(function() { localStorage.tres = "true"; }) }
if(localStorage.getItem('primeira') == "true"){ chrome.windows.onCreated.addListener(function() { localStorage.dois = "true"; }) }
...
if(localStorage.atualizacao57 == "true"){
	...
	notif = chrome.notifications.create("changelog", { type: "list", iconUrl: "icons/icon_64.png", title: "DescicloApp atualizado: Vers\u00E3o 6.0", message: "", items: [ { title: "NOTA", message: "DescicloToolbar agora desativada por padr\u00E3o, se voc\u00ea a usava ent\u00E3o ative-a novamente nas op\u00e7\u00F5es"}, { title: "", message: "Nova fun\u00e7\u00E3o de receber notifica\u00e7\u00F5es de novas mensagens."}, { title: "", message: "Widget de mudan\u00e7as recentes melhorado."}, { title: "", message: "E outras melhoras menores."},], buttons: [{ title: 'Ver changelog completo', iconUrl: 'imagens/externowp7.png' }, { title: 'Abrir op\u00e7\u00F5es', iconUrl: 'imagens/externowp7.png' }], priority: 2}, function() { if(!localStorage.username){ localStorage.setItem('notifmsg', 'false'); localStorage.setItem('username', ''); } else { addNewPage('Mensagens', 'http://pesquisa.la/index.php?title=Usu%C3%A1rio_Discuss%C3%A3o:' + localStorage.getItem('username') + '&action=history', 'chrome-extension://pjglehbpmemdjndlpebplmocdkfjolpj/icons/icon_16.png'); localStorage.setItem('notifmsg', 'true'); }; localStorage.setItem('pref_tb_is_visible', 'false'); });
	...
	localStorage.atualizacao60 = "true";
	notif = chrome.notifications.create("changelog", { type: "list", iconUrl: "icons/icon_64.png", title: "DescicloApp: Vers\u00E3o 6.0", message: "", items: [ { title: "NOTA", message: "Passe o mouse em cima"}, { title: "", message: "Nova fun\u00e7\u00E3o de receber notifica\u00e7\u00F5es de novas mensagens."}, { title: "", message: "Widget de mudan\u00e7as recentes melhorado."}, { title: "", message: "Pode escolher qualquer dom\u00EDnio para ser seu favorito, inclusive de outras wikis"}, { title: "", message: "Pode escolher os bot\u00F5es que aparecem na popup"} ], buttons: [{ title: 'Ver changelog completo', iconUrl: 'imagens/externowp7.png' }], priority: 0}, function() {});
	chrome.notifications.onButtonClicked.addListener(function(changelog, buttonIndex) {
		if (buttonIndex == 0) {
			window.open('paginas/changelog.html');
			chrome.notifications.clear(changelog, function(wasCleared) {});
