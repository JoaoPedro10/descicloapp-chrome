...
if (!Array.prototype.reduce) {
    // See http://es5.github.com/#x15.4.4.21
...
// Production steps of ECMA-262, Edition 5, 15.4.4.4
// Reference: http://es5.github.com/#x15.4.4.4
if (!Array.prototype.concat)
{
  Array.prototype.concat = function(dummyArgument) {
    var O = Object(this);
    var A = []; // what we actually return
    var n = 0;
    var items = [O];
